...
<head>
    ...
    <title>Access Denied &middot; Downtown Bellefontaine</title>
...
<body>
    <main class="card">
        ...
        <h1>Sorry, this door is locked.</h1>
        <p class="lead">You don&rsquo;t have permission to view this page. If you think you should, try signing in &mdash; otherwise, let&rsquo;s get you back to the good stuff.</p>
        <div class="actions">
