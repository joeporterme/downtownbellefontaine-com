...
<head>
    ...
    <title>Page Expired &middot; Downtown Bellefontaine</title>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .btn{display:inline-flex;align-items:center;gap:8px;font-weight:700;font-size:15px;text-decoration:none;padding:13px 26px;border-radius:999px;transition:transform .15s ease,box-shadow .15s ease;cursor:pointer;border:none;font-family:inherit}
        ...
        .btn-ghost{background:transparent;color:var(--teal);border:2px solid var(--border)}
        .btn-ghost:hover{transform:translateY(-2px);border-color:var(--teal)}
        @media (prefers-color-scheme: dark){.btn-ghost{color:#3aa7b0}}
        .footnote{margin-top:24px;font-size:12.5px;color:var(--muted);opacity:.8;border-top:1px solid var(--border);padding-top:22px}
...
<body>
    <main class="card">
        ...
        <h1>This page took a little nap.</h1>
        <p class="lead">For your security, the page expired before your request went through. Just refresh and try submitting again &mdash; your details should still be there.</p>
        <div class="actions">
            <button class="btn btn-primary" onclick="location.reload()">Refresh &amp; try again</button>
