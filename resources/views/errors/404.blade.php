...
<head>
    ...
    <title>Page Not Found &middot; Downtown Bellefontaine</title>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .watermark{
            position:absolute;right:-40px;bottom:-40px;width:220px;opacity:.06;
            pointer-events:none;user-select:none;
        }
        .logo{height:40px;width:auto;margin:0 auto 28px;display:block}
        .pineapple{height:96px;width:auto;margin:0 auto 18px;display:block;
            filter:drop-shadow(0 12px 18px rgba(1,67,76,.25));}
        .code{
            font-weight:900;font-size:14px;letter-spacing:.22em;text-transform:uppercase;
            color:var(--teal);display:inline-block;margin-bottom:10px;
        }
        ...
        .btn{
            ...
            text-decoration:none;padding:13px 26px;border-radius:999px;transition:transform .15s ease,box-shadow .15s ease;
        }
        ...
        .links{
            ...
            border-top:1px solid var(--border);padding-top:22px;margin-top:4px;
        }
        .links a{
            color:var(--ink);text-decoration:none;font-weight:600;font-size:14px;opacity:.85;
        ...
        @media (max-width:480px){
            .card{padding:38px 24px 32px;border-radius:22px}
            h1{font-size:25px}p.lead{font-size:16px}
        }
    </style>
</head>
<body>
    <main class="card">
        ...
        <h1>Well, this corner of downtown is empty.</h1>
        <p class="lead">We couldn&rsquo;t find the page you were looking for. It may have moved, closed up shop, or never existed &mdash; but there&rsquo;s still plenty to explore.</p>
        <div class="actions">
