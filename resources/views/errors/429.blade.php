...
<head>
    ...
    <title>Slow Down a Moment &middot; Downtown Bellefontaine</title>
...
<body>
    <main class="card">
        ...
        <span class="code">Error 429</span>
        <h1>Whoa there &mdash; let&rsquo;s slow down.</h1>
        <p class="lead">You&rsquo;ve made a few too many requests in a short time. Take a breather for a minute, then give it another go. We&rsquo;ll be right here.</p>
        <div class="actions">
