...
<head>
    ...
    <title>Down for Maintenance &middot; Downtown Bellefontaine</title>
...
<body>
    <main class="card">
        ...
        <p class="lead">Downtown Bellefontaine is closed for a quick spruce-up. We&rsquo;re making things better and will reopen shortly &mdash; thanks for stopping by!</p>
        <div class="actions">
            <button class="btn btn-primary" onclick="location.reload()">Refresh the page</button>
        </div>
