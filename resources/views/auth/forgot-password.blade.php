    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-100 dark:bg-primary-900 mb-4">
                <i class="fa-duotone fa-light fa-key text-3xl text-primary-600 dark:text-primary-400"></i>
            </div>
            <h1 class="text-3xl font-bold text-theme-primary">Reset Your Password</h1>
            <p class="mt-2 text-theme-tertiary">Enter your email address and we'll send you a link to reset your password.</p>
        </div>
        ...
        <p class="text-center mt-6 text-theme-tertiary text-sm">
            ...
            <a href="{{ route('login') }}" class="text-primary-600 dark:text-primary-400 hover:underline font-medium">Back to sign in</a>
        </p>
    </div>
</div>
@endsection
